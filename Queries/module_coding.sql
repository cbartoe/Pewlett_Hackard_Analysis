...
FROM employees as e
LEFT JOIN titles as t ON e.emp_no = t.emp.no
...
-- query to find employees retiring from sales
-- emp_no, first_name, last_name, dept_name
DROP TABLE sales_dev_mentor;
SELECT 	emp_no,
		first_name,
		last_name,
		dept_name
INTO sales_dev_mentor
FROM dept_info
WHERE (dept_name IN ('Sales', 'Development'));

SELECT * FROM sales_dev_mentor;